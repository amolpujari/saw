...
Add this line to your application's Gemfile:
    ...
    gem 'saw', :git => "git://github.com/amolpujari/saw.git", :branch => 'roost'
...
== Usage
    ...
    define visit_source in ApplicationController which should return a string saying the source of this visit
...
A visit is not a single request made to the server but a session. Similalry a link is not necessary to be a request link.
